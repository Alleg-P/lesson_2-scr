...
class Vehicle(Moveable):
    ...
    @classmethod
    def create_vehicle(cls, vehicle_type: VehicleType, speed: float) -> VehicleType:
...
class Boat(Vehicle):
    def move(self) -> None:
        print(f"Скорость лодки {self.speed} морских миль/час")
...
bike1 = Vehicle.create_vehicle(VehicleType.BIKE, 15)
